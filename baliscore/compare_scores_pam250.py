    ...
    try:
        ...
        with open(output_file, 'w', newline='') as csvfile:
            ...
            for xml_file in sorted(xml_files):
                ...
                # Modificado aqui para usar o novo padrão de nome
                clustalw_file = clustalw_dir / f"{base_name}_clustalw_pam250.fasta"
...
def main():
    if len(sys.argv) != 2:
        print("Uso: python3 compare_scores.py <arquivo_saída.csv>")
        print("Exemplo: python3 compare_scores.py scores_pam250.csv")
        sys.exit(1)
    
    # Diretórios fixos
    xml_dir = Path("/home/augusto/projects/multiOne/BAliBASE/RV100")
    clustalw_dir = Path("/home/augusto/projects/multiOne/baliscore/clustalw_pam250_results")
